...
def simulate_season(
    ...
    for race in calendar:
        ...
        scores = [t.pace + rng.uniform(-0.8, 0.8) for t in all_teams]
        ...
        races.append(
            RaceResult(
                ...
                user_wdc_points_after=max(
                    driver_points.get(user_team.driver_1.display_name, 0),
                    driver_points.get(user_team.driver_2.display_name, 0),
                ),
